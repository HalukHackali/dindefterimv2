...
class _AsrState extends State<Asr> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      await player.setSource(AssetSource('sureler_sound/asr_suresi.mp3'));
      await player.resume();
    });
  }
              ...
              child: Column(
                children: [
                  ...
                  const Padding(
                    padding: EdgeInsets.all(14.0),
                    child: Text(
                      " وَالْعَصْرِ  ﴿١﴾ إِنَّ الْإِنْسَانَ لَفِي خُسْرٍ ﴿٢﴾ إِلَّا الَّذِينَ آمَنُوا ِۜ ﴿٤﴾وَعَمِلُوا الصَّالِحَاتِ وَتَوَاصَوْا بِالْحَقِّ وَتَوَاصَوْا بِالصَّبْر ﴿٣﴾ِ ",
                      style: TextStyle(
                        fontSize: 24,
                      ),
                      textDirection: TextDirection.rtl,
