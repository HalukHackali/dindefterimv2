...
class Maun extends StatefulWidget {
  const Maun({super.key});


  @override
  State<Maun> createState() => _MaunState();
}

class _MaunState extends State<Maun> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      await player.setSource(AssetSource('sureler_sound/maun_suresi.mp3'));
      await player.resume();
    });
  }
